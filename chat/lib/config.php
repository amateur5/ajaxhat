...
// Database hostname (tvoj Render host):
$config['dbConnection']['host'] = 'dpg-ct15qb1u0jms73ccn2l0-a.frankfurt-postgres.render.com';  
// Database username (tvoje korisničko ime za PostgreSQL):
$config['dbConnection']['user'] = 'ajaxchat_user';  
// Database password (tvoja lozinka):
$config['dbConnection']['pass'] = 'ubZQSIeStDA6b1iIWgI5BJQE6HVFyFw6';  
// Database name (ime tvoje baze):
$config['dbConnection']['name'] = 'ajaxchat';  
// Database type (za PostgreSQL postavi "pgsql"):
$config['dbConnection']['type'] = 'pgsql';  
// Database link (ostavi null, koristi kasnije za konekciju):
